...
var NorenRestApi = function (params) {
  ...
  /** code added by rahul **/
  self.customSetSession = function () {
    console.log("rahul");
    self.__susertoken =
      "e1856b838f6351b87e762194bdec44860238614889a1f18e85af56184cb83b39";
    self.__username = "FA54017";
    self.__accountid = "FA54017";
  };
  ...
  self.searchscrip = function (exchange, searchtext) {
    ...
    console.log("rahul", self.__susertoken);
